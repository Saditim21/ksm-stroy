...
export const seoData = {
  ...
  contact: {
    ...
    description: "Свържете се с KSM Stroy за безплатна консултация и оферта. Офис в София, телефон: +359887886166, имейл: ksm_str@abv.bg. Работно време: Пн-Пт 8:00-18:00.",
