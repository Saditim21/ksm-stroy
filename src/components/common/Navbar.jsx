      ...
      <div className="w-full px-6 lg:px-12 xl:px-20">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            {/* Optional: User Profile Icon (if needed in future) */}
            <button className="ml-2 p-2 rounded-luxury hover:bg-white/5 transition-colors duration-200 group">
              <svg className="w-5 h-5 text-platinum-300 group-hover:text-gold-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {isOpen && (
          <div className="lg:hidden absolute left-0 right-0 top-full bg-primary-900/98 backdrop-blur-lg border-t border-gold-500/20 shadow-2xl">
            <div className="px-6 pt-4 pb-6 space-y-1">
              ...
              {/* Mobile User Profile Option */}
              <div className="pt-3">
                <button className="w-full flex items-center justify-center space-x-2 px-4 py-3 text-platinum-300 hover:text-gold-400 hover:bg-white/5 rounded-luxury transition-all duration-200">
