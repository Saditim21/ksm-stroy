...
const GoldenResidenceSingleBlock = () => {
  ...
  const blockAFloorData = {
    ...
    7: [
      ...
      { apartment: 'А 709', built: '61.11', ideal: '8.77', вид: '2-стаен', total: '69.88', изложение: 'Запад', status: 'Свободен' },
    ...
    8: [
      ...
      { apartment: 'А 806', built: '100.20', ideal: '14.38', вид: '3-стаен', total: '114.58', изложение: 'Север/Запад', status: 'Продадени' },
      { apartment: 'А 807', built: '61.11', ideal: '8.77', вид: '2-стаен', total: '69.88', изложение: 'Запад', status: 'Продадени' },
