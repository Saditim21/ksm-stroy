...
export const FLOOR_DATA = {
  'A': {
    ...
    9: {
      ...
      status: 'available',
      apartments: [
        { имот: 'А-801', вид: '3-стаен', застроенаПлощ: '78 м²', общаПлощ: '95 м²', изложение: 'Юг/Изток', статус: 'Продаден' },
        { имот: 'А-802', вид: 'Двустаен', застроенаПлощ: '62 м²', общаПлощ: '69.15 м²', изложение: 'Запад', статус: 'Свободен' },
        { имот: 'А-803', вид: '4-стаен', застроенаПлощ: '98 м²', общаПлощ: '115 м²', изложение: 'Север/Изток', статус: 'Продаден' },
        { имот: 'А-804', вид: '1-стаен', застроенаПлощ: '45 м²', общаПлощ: '55 м²', изложение: 'Север', статус: 'Продаден' },
        { имот: 'А-805', вид: '2-стаен', застроенаПлощ: '68 м²', общаПлощ: '82 м²', изложение: 'Изток/Юг', статус: 'Продаден' },
        { имот: 'А-806', вид: '3-стаен', застроенаПлощ: '85 м²', общаПлощ: '102 м²', изложение: 'Юг', статус: 'Резервиран' },
        { имот: 'А-807', вид: '1-стаен', застроенаПлощ: '42 м²', общаПлощ: '52 м²', изложение: 'Изток', статус: 'Резервиран' },
        { имот: 'А-808', вид: 'Двустаен', застроенаПлощ: '105 м²', общаПлощ: '63.87 м²', изложение: 'Запад/Юг', статус: 'Свободен' },
      ],
      planImage: buildingAllFloorsArchitectureImage
    },
    8: {
    ...
    2: {
      ...
      status: 'available',
      apartments: [
        { имот: 'А-101', вид: '2-стаен', застроенаПлощ: '62 м²', общаПлощ: '75 м²', изложение: 'Север', статус: 'Продаден' },
        { имот: 'А-102', вид: '2-стаен', застроенаПлощ: '78 м²', общаПлощ: '69.15 м²', изложение: 'Юг/Запад', статус: 'Свободен' },
        { имот: 'А-103', вид: '1-стаен', застроенаПлощ: '42 м²', общаПлощ: '52 м²', изложение: 'Изток', статус: 'Продаден' },
        ...
        { имот: 'А-106', вид: '3-стаен', застроенаПлощ: '85 м²', общаПлощ: '100.75 м²', изложение: 'Запад', статус: 'Свободен' },
  ...
  'B': {
    ...
    8: {
      ...
      status: 'available',
      apartments: [
        { имот: 'Б-701', вид: '2-стаен', общаПлощ: '75 м²', изложение: 'Запад', статус: 'Продаден' },
        { имот: 'Б-702', вид: '2-стаен', общаПлощ: '69.12 м²', изложение: 'Юг/Изток', статус: 'Свободен' },
        ...
        { имот: 'Б-707', вид: '3-стаен', общаПлощ: '100.71 м²', изложение: 'Изток', статус: 'Свободен' },
    ...
    7: {
      ...
      apartments: [
        ...
        { имот: 'Б-602', вид: '2-стаен', общаПлощ: '78 м²', изложение: 'Север', статус: 'Продаден' },
        ...
        { имот: 'Б-607', вид: '3-стаен', общаПлощ: '100.71 м²', изложение: 'Север/Запад', статус: 'Свободен' },
    ...
    5: {
      ...
      status: 'available',
      apartments: [
        { имот: 'Б-401', вид: '3-стаен', общаПлощ: '95 м²', изложение: 'Юг/Изток', статус: 'Резервиран' },
        { имот: 'Б-402', вид: '2-стаен', общаПлощ: '75 м²', изложение: 'Север', статус: 'Продаден' },
        { имот: 'Б-403', вид: '4-стаен', общаПлощ: '130 м²', изложение: 'Юг/Изток/Запад', статус: 'Продаден' },
        ...
        { имот: 'Б-407', вид: '3-стаен', общаПлощ: '100.71 м²', изложение: 'Изток/Юг', статус: 'Свободен' },
    ...
    4: {
      ...
      status: 'available',
      apartments: [
        { имот: 'Б-301', вид: '2-стаен', общаПлощ: '75 м²', изложение: 'Север', статус: 'Продаден' },
        ...
        { имот: 'Б-307', вид: '3-стаен', общаПлощ: '100.71 м²', изложение: 'Изток/Юг', статус: 'Свободен' },
    ...
    3: {
      ...
      status: 'available',
      apartments: [
        { имот: 'Б-201', вид: '4-стаен', общаПлощ: '115 м²', изложение: 'Запад/Юг', статус: 'Резервиран' },
        { имот: 'Б-202', вид: '2-стаен', общаПлощ: '78 м²', изложение: 'Север', статус: 'Продаден' },
        ...
        { имот: 'Б-207', вид: '3-стаен', общаПлощ: '100.71 м²', изложение: 'Запад', статус: 'Свободен' },
