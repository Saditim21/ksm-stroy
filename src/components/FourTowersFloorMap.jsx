...
export const FLOOR_DATA = {
  ...
  'B': {
    ...
    1: { 
      ...
      status: 'available',
      apartments: [
        { имот: 'Б-101', вид: '2-стаен', общаПлощ: '75 м²', изложение: 'Север', статус: 'Свободен' },
        { имот: 'Б-102', вид: '2-стаен', общаПлощ: '69.12 м²', изложение: 'Юг/Запад', статус: 'Свободен' },
        { имот: 'Б-103', вид: '1-стаен', общаПлощ: '52 м²', изложение: 'Изток', статус: 'Свободен' },
        ...
        { имот: 'Б-106', вид: '3-стаен', общаПлощ: '98 м²', изложение: 'Запад', статус: 'Продаден' },
        { имот: 'Б-107', вид: '1-стаен', общаПлощ: '55 м²', изложение: 'Юг', статус: 'Продаден' },
